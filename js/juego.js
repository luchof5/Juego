...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 220, 400, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 330, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 450, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 420, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 460, 280, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 390, 200, 30, 15, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 205, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 775, 190, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 175, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 760, 190, 30, 30, 1),
  ...
  enemigos: [
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0 , 30, 90),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0 , 30, 90, 10, ),
    new ZombieCaminante('imagenes/zombie1.png', 500, 100, 10, 10),
    new ZombieCaminante('imagenes/zombie2.png', 800, 380, 10, 10),
    new ZombieCaminante('imagenes/zombie3.png', 760, 450, 10, 10),
    new ZombieCaminante('imagenes/zombie4.png', 300, 490, 10, 10),
    new ZombieCaminante('imagenes/zombie1.png', 550, 370, 10, 10),
    new ZombieCaminante('imagenes/zombie2.png', 370, 230, 10, 10)
  ]
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      if (obstaculo.potencia > 0) {
        Obstaculo.chocar(Jugador.vidas);
        obstaculo.potencia--;
      }
